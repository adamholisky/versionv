...
static unsigned int l_pageSize  = PAGE_SIZE_IN_BYTES;			///< The size of an individual page. Set up in liballoc_init.
static unsigned int l_pageCount = SBRK_NUM_PAGES;			///< The number of pages to request per chunk. Set up in liballoc_init.
